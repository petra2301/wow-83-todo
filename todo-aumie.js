...
//link https://todolist2019-e565.restdb.io/rest/aumie-twistingnether

get();

function get() {
  fetch("https://todolist2019-e565.restdb.io/rest/aumie-twistingnether", {
    method: "get",
    headers: {
...
function changeStatus(id) {
  ...
  fetch("https://todolist2019-e565.restdb.io/rest/aumie-twistingnether/" + id,
    {
        method: "put",
        headers: {
            "Content-Type": "application/json; charset=utf-8",
